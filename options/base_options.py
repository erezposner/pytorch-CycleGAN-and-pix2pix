...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--constant_data', type=int, default=0,
                            help='if debug and want to use constant path data')  # TODO change to zero
        # model parameters
        ...
        parser.add_argument('--output_flame_params', default=418, action='store_true',
                            help='set number of params for your parametric model')
        # dataset parameters
